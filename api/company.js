...
export function authRecord(data) { // 用户认证记录
  return request({
    url: `/v2/u/auth/record`,
    method: 'GET',
  })
}
...
export function ocr(data) { // ocr
  return request({
    url: `/v2/company/ocr?fileUrl=` + data.license,
    method: 'GET'
  })
}
...
export function memberList() { // 企业成员列表查询
  return request({
    url: `/v1/company/member/list`,
    method: 'GET',
  })
}

export function memberCreate(data) { // 企业成员添加
  return request({
    url: `/v1/company/member`,
    method: 'POST',
    data
  })
}
export function memberUpdate(data) { // 企业成员修改数据
  return request({
    url: `/v1/company/member/${data.id}`,
    method: 'PUT',
    data
  })
}
export function memberInfo(id) { // 企业成员数据
  return request({
    url: `/v1/company/member/${id}`,
    method: 'GET',
  })
}
export function memberDel(id) { // 企业成员删除
  return request({
    url: `/v1/company/member/` + id,
    method: 'DELETE',
  })
...
export function getSealList(id) { // 印章管理列表
  return request({
    url: `/v1/company/member/${id}/seal`,
    method: 'GET',
  })
}


export function sealAuth(data) { // 印章管理列表
  return request({
    url: `/v1/company/member/${data.id}/sealAuth`,
    method: 'POST',
	data
  })
}

export function unSealAuth(data) { // 印章管理列表
  return request({
    url: `/v1/company/member/${data.id}/unSealAuth`,
    method: 'DELETE',
	data
  })
}